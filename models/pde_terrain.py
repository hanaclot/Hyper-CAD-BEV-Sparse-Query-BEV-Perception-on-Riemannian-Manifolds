# -*- coding: utf-8 -*-
"""
Hyper-CAD-BEV v6.5-Sparse: PDE Terrain and Implicit BEV Field
...
print('pde_terrain.py loaded - OffroadTerrainGenerator, ReactionDiffusionPDE, ImplicitBEVField ready')
