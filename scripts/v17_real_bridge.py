# -*- coding: utf-8 -*-
""""
v17_real_bridge.py — 真正的端到端实验：桥接核心模型与实验
核心修复:
 1. manifold.height_field 从真实地形设置 (非zero) → 度量张量有实际作用
...
pde_module = full_model.pde  # 注意：这是20类的PDE，需要为高度图创建1类版本
...
def np_metric_tensor(h_norm):
    """纯NumPy计算度量张量（用于欧几里得/Riemannian对比）"""
